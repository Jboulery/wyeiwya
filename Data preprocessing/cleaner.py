...
with open('en.openfoodfacts.org.products.csv','r',encoding="utf-8") as tsvin, open('food_data.csv', 'w',encoding='utf-8') as csvout:
    ...
    for row in tsvin:
        if len(row)==163:
            ...
            data = [code,product_name,categories_tag,origins_tag,labels_tags,countries_tag,traces_tag,additives_n]
            data += [ingredients_from_palm_oil_n,ingredients_that_may_be_from_palm_oil_n,nutrition_grade_uk,nutrition_grade_fr,main_category]
            ...
            data += [sugars_100g,fiber_100g,proteins_100g,salt_100g,sodium_100g,alcohol_100g,vitamin_a_100g,vitamin_d_100g,vitamin_c_100g,potassium_100g]
            data += [calcium_100g,iron_100g,magnesium_100g,zinc_100g,copper_100g,manganese_100g,nutrition_score_uk_100g]
